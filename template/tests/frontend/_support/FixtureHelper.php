...
class FixtureHelper extends Module
{
    ...
    public function fixtures()
    {
        return [
			'user' => [
				'class' => \tests\codeception\common\fixtures\UserFixture::className(),
                'dataFile' => '@tests/codeception/common/fixtures/data/user.php'
			],
			/*
            'invoice' => [
                'class' => \tests\codeception\common\fixtures\InvoiceFixture::className(),
                'dataFile' => '@tests/codeception/common/fixtures/data/invoice.php'
            ],*/
        ];
    }
}
