...
$config = [
    ...
    'aliases' => [
        ...
        '@common/rbac/views' => '@vendor/inspirenmy/yii2-core/src/rbac/views',
		'@common/migrations' => '@vendor/inspirenmy/yii2-core/src/migrations',
    ...
    'components' => [
        ...
        'moduleManager' => [
			...
			'moduleAutoloadPaths' => ['@ant', 
				...
				env('PACKAGES_PATH', '@vendor/inspirenmy').'/yii2-user/src/common/modules',
				env('PACKAGES_PATH', '@vendor/inspirenmy').'/yii2-user/src',
				env('PACKAGES_PATH', '@vendor/inspirenmy').'/yii2-core/src/common/modules',
				...
				env('PACKAGES_PATH', '@vendor/antweb').'/yii2-event/src/common',
